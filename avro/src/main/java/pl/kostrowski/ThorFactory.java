...
import pl.kostrowski.avro.ThorSkills;
...
public class ThorFactory {
    ...
    public Thor createThor() {
        return Thor.newBuilder()
                .setName(generateRandomString())
                .setSurname(generateRandomString())
                .setBirthDate(generateRandomDate())
    ...
    private List<ThorSkills> generateRandomSkills() {
        ...
        for (int i = 0; i < numberOfSkills; i++) {
            skills.add(ThorSkills.newBuilder()
                               .setSkillName(generateRandomString())
                               .setSkillDescription(generateRandomString())
                               .setSkillCost(generateRandomBigDecimal())
                               .setSkillDate(generateRandomDate())
                               .build());
        }
        return skills;
    }
